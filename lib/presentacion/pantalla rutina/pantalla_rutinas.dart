...
class _PantallaRutinasState extends State<PantallaRutinas> {
        ...
        child: Scaffold(
          ...
          body: BlocBuilder<RutinasCubit, RutinasState>(
            builder: (context, state) {
              print(
                '🔄 PantallaRutinas: BlocBuilder llamado - Estado: ${state.runtimeType}',
              );
  ...
  Widget _buildRutinaCard(Rutina rutina) {
    ...
    for (int dia = 1; dia <= 7; dia++) {
      ...
      final alimentosDelDia =
          rutina.alimentos.where((a) => a.dia == dia).toList();
            ...
            child: Column(
              ...
              children: [
                ...
                ...List.generate(
                  7,
                  (dia) =>
                      _buildDiaItem(rutina, dia + 1, diasCompletados[dia + 1]!),
                ),
              ],
            ),
          ),
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () async {
          ...
          final estadoActual =
              alimentosDelDia.isNotEmpty
                  ? alimentosDelDia.first.completada
                  : completado;
                    ...
                    child: Row(
                      children: [
                        Icon(
                          ...
                          size: 16,
                          color:
                              completado ? Colors.grey : Colors.blue.shade700,
                        ),
